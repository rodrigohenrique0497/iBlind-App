    ...
    <div className="space-y-10 animate-premium-in">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-2 text-left">
          <h2 className="text-4xl brand-font-bold tracking-tight uppercase text-foreground">Time de Especialistas</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredSpecialists.map(spec => {
          ...
          return (
            <IBCard key={spec.id} className="relative group overflow-hidden text-left">
              ...
              <div className="flex items-center gap-5 mb-8">
                <div className="w-16 h-16 rounded-2xl bg-muted border border-border flex items-center justify-center text-foreground/40 group-hover:bg-foreground group-hover:text-background transition-all duration-500">
                  <Shield size={32} />
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-[10px] text-foreground/40 font-bold uppercase truncate max-w-[150px]">{spec.email}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-muted border border-border rounded-2xl">
                  <p className="text-[8px] font-black text-foreground/30 uppercase tracking-widest mb-1">SERVIÇOS</p>
                ...
                <div className="p-4 bg-muted border border-border rounded-2xl">
                  <p className="text-[8px] font-black text-foreground/30 uppercase tracking-widest mb-1">PRODUÇÃO</p>
                  <div className="flex items-center gap-2">
      ...
      {isAdding && (
        <div className="fixed inset-0 z-[600] bg-background/95 backdrop-blur-xl flex items-center justify-center p-6 animate-premium-in">
          <div className="w-full max-w-lg bg-card border border-border rounded-[40px] p-10 space-y-8 premium-shadow text-left">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-2xl brand-font-bold uppercase text-foreground">Novo Especialista</h3>
                <p className="text-[9px] font-black text-foreground/30 uppercase tracking-widest mt-1">Cadastro de Operador Técnico</p>
              </div>
              <button onClick={() => setIsAdding(false)} className="w-12 h-12 flex items-center justify-center bg-muted rounded-2xl text-foreground/40 hover:text-foreground transition-all"><X size={24}/></button>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 bg-muted rounded-2xl border border-border space-y-2">
                <p className="text-[8px] font-black text-foreground/30 uppercase tracking-widest">NÍVEL DE PERMISSÃO</p>
                <div className="flex items-center gap-3">
                  <Shield size={16} className="text-emerald-500" />
                  <span className="text-[10px] font-bold text-foreground uppercase tracking-widest">Especialista Operacional</span>
                </div>
              </div>
            </div>
